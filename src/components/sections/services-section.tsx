...
const services = [
  ...
  {
    title: "Аватарка",
    description: "Персональный аватар для соцсетей, фирменный стиль и узнаваемость.",
    price: "от 150 ₽",
    direction: "right",
  },
  {
  ...
  {
    title: "Коллаж / Обои",
    description: "Разноформатные обои на любой вкус, тематические коллажи для соцсетей, блогов и рекламы.",
    price: "от 400 ₽",
    direction: "bottom",
  },
]
