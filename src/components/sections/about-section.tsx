          ...
          <div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Оформляю визуальный образ для бизнеса и личного бренда: от аватарок до pitch-deck презентаций на 30+ слайдов.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Всё создаётся в веб-формате — удобно для публикаций, соцсетей и прямых ссылок. Нестандартные запросы — приветствую.
              </p>
            </div>
          </div>
